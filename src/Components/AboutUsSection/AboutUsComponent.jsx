const AboutUsComponent = () => {
  return (
    <div className="dark:bg-gray-100 dark:text-gray-800">
      <div className="px-4 py-16 mx-auto max-w-7xl sm:px-6 md:px-10 lg:px-28">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-extrabold sm:text-4xl">
            All About us you need to know
          </h2>
          <p className="mt-4 text-lg dark:text-gray-600">
            We are a US based company operating all over the world by providing
